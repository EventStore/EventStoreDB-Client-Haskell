...
module Database.EventStore.Grpc.Wire.Persistent_Fields where
...
checkpointAfterMs ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "checkpointAfterMs" a) =>
  Lens.Family2.LensLike' f s a
checkpointAfterMs = Data.ProtoLens.Field.field @"checkpointAfterMs"
checkpointAfterTicks ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "checkpointAfterTicks" a) =>
  Lens.Family2.LensLike' f s a
checkpointAfterTicks
  = Data.ProtoLens.Field.field @"checkpointAfterTicks"
commitPosition ::
  forall f s a.
  (Prelude.Functor f,
...
maybe'checkpointAfter ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'checkpointAfter" a) =>
  Lens.Family2.LensLike' f s a
maybe'checkpointAfter
  = Data.ProtoLens.Field.field @"maybe'checkpointAfter"
maybe'checkpointAfterMs ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'checkpointAfterMs" a) =>
  Lens.Family2.LensLike' f s a
maybe'checkpointAfterMs
  = Data.ProtoLens.Field.field @"maybe'checkpointAfterMs"
maybe'checkpointAfterTicks ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'checkpointAfterTicks" a) =>
  Lens.Family2.LensLike' f s a
maybe'checkpointAfterTicks
...
maybe'messageTimeoutMs ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'messageTimeoutMs" a) =>
  Lens.Family2.LensLike' f s a
maybe'messageTimeoutMs
  = Data.ProtoLens.Field.field @"maybe'messageTimeoutMs"
maybe'messageTimeoutTicks ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'messageTimeoutTicks" a) =>
  Lens.Family2.LensLike' f s a
maybe'messageTimeoutTicks
...
messageTimeoutMs ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "messageTimeoutMs" a) =>
  Lens.Family2.LensLike' f s a
messageTimeoutMs = Data.ProtoLens.Field.field @"messageTimeoutMs"
messageTimeoutTicks ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "messageTimeoutTicks" a) =>
  Lens.Family2.LensLike' f s a
messageTimeoutTicks
  = Data.ProtoLens.Field.field @"messageTimeoutTicks"
metadata ::
  forall f s a.
  (Prelude.Functor f,
